...
career_now_actor = Career(
    ...
    desc="A star of screen or stage, you make your living pretending to be somebody else. Each time you take this "
...
career_now_astronaut = Career(
    ...
    desc="You trained to become an astronaut and travelled into space, either into orbit or to the moon or a similar "
         "body.",
    available_exploits=[
...
career_now_boot_camp = Career(
    ...
    desc="You joined the military and completed basic military training. Some programs send recruits to college to "
...
career_now_boxer = Career(
    ...
    desc="The ring is your king. You have been in scores of fights (both sanctioned and otherwise), endured countless "
...
career_now_college = Career(
    ...
    desc="You attended a civilian college or university and gained formal qualifications in a chosen area of study. "
...
career_now_con_artist = Career(
    ...
    desc="You honed your skills and learned how to trick others out of their money with charm, lies, bluffs, "
...
career_now_craftsman = Career(
    ...
    desc="You made your living by practising your craft as a carpenter, electrician, mechanic, or other professional "
         "skilled worker.",
...
career_now_dark_crusader = Career(
    ...
    desc="You prowl the streets at night. More than just a vigilante, you are a symbol. You have learned how to "
...
career_now_detective = Career(
    ...
    available_skills=['interrogation', 'pistols', 'driving', 'bureaucracy', 'perception', 'intimidate', 'stealth',
                      'tracking', 'law'],
    desc="You become a detective, expert at spotting clues and finding your man. Even if you leave the profession, "
...
career_now_diver = Career(
    ...
    desc="Whether it was a commercial job, or for the military or police, you feel most at home in a wetsuit. You "
...
career_now_drifter = Career(
    ...
    desc="Somehow you lost your way. Drinking, gambling, with no clear objective, you drifted through the fringes of "
...
career_now_driver = Career(
    ...
    desc="You became a driver. Either a racing driver, such as Formula 1 or NASCAR, or a getaway driver. You may even "
...
career_now_explosives_expert = Career(
    ...
    desc="You were either a bomb disposal or a demolitions expert.You just love the smell of napalm in the morning. "
...
career_now_guerrilla_fighter = Career(
    ...
    desc="Either as a dangerous lone wolf or as part of an organized resistance, you're experienced with waging war "
...
career_now_heavy_gunner = Career(
    ...
    desc="A real weapon is the kind that requires a strap, and if it doesn't kick like a mule when you fire it, "
...
career_now_infiltrator = Career(
    ...
    desc="The pinnacle of special operations, either police, military or freelance, the infiltrator aptly describes "
...
career_now_laborer = Career(
    ...
    available_skills=['[crafting]', 'carousing', 'hardy', 'computers', '[outdoor]', 'bureacracy', 'engineering',
                      '[vehicle]'],
    desc="You did a regular physical job, whether skilled or unskilled, performing manual work for a fair wage. You "
...
career_now_lawyer = Career(
    ...
    desc="You became a lawyer, learning the complexities of the legal system, and how to get yourself and others out "
         "of (or into!) trouble.",
...
career_now_medic = Career(
    ...
    desc="You enter the medical profession. If you have gained a doctorate at college, you do so as a doctor; "
...
career_now_ninja = Career(
    ...
    desc="The skills and tactics of Japan's warriors of subterfuge, sabotage, and deception are known to you, "
...
career_now_private_eye = Career(
    ...
    available_skills=['pistols', 'bluffing', 'bribery', 'perception', 'insight', 'tracking', 'intimidate',
                      '[subterfuge]'],
    desc="You snoop, bribe, tail, and occasionally get socked a few times a month in order to pay the bills. You know "
...
career_now_scientist = Career(
    ...
    desc="You take your science with you as investigate phenomena in strange locations. Field scientists are viewed "
...
career_now_sniper = Career(
    ...
    desc="You mastered the art of lying very still for long periods of time and shooting people a long way away. "
...
career_now_soldier = Career(
    ...
    desc="A tour of duty in the army means a deployment to a probably dangerous environment where you engaged enemy "
...
career_now_spy = Career(
    ...
    desc="You're a spy. This may be MI6, CIA, KGB, or some other force. You have a wide remit, dealing with both "
...
career_now_stuntman = Career(
    ...
    desc="You've rolled cars, jumped off buildings, jumped open drawbridges, even set yourself on fire in the name of "
         "entertainment.",
...
career_now_survivalist = Career(
    ...
    desc="Some choose to spend time in the wild, testing their mind and body against nature, living off the land, "
...
career_now_vigilante = Career(
    ...
    desc="Something about the world calls to you, asking—no, demanding—that you rise above the law to accomplish some "
