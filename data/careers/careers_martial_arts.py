...
career_ma_aikido = Career(
    ...
    desc="Blending the force of your attacker with your own movements, you have mastered the art of redirecting a "
...
career_ma_brazilian_jujutsu = Career(
    ...
    desc="Taking your opponents down with expert technique and leverage, you take them to the ground, where you are a "
         "master combatant.",
    available_exploits=[
...
career_ma_capoeira = Career(
    ...
    desc="Training with a capoeira master, you’ve become more adept at the acrobatic martial art, able to tumble, "
...
career_ma_gun_fu = Career(
    ...
    desc="You have mastered the synthesis of modern weaponry with ancient martial arts, able to maximize the power "
...
career_ma_gun_kata = Career(
    ...
    desc="You have learned the unusual but beautiful art of melee gun combat, where the gun is considered a total "
...
career_ma_jujutsu = Career(
    ...
    desc="Trained in fighting an armed opponent with your feet and fists, you are a fluid warrior in combat, "
...
career_ma_karate = Career(
    ...
    desc="You learned a striking art which focuses on punches, kicks, and knee and able strikes, as well as open hand "
         "strikes.",
    available_exploits=[{'Name': "Curriculum exploits",
                         'Desc': "Choose any three hard exploits from the Universal Exploits for Martial Artists "
                                 "sidebar."},
...
career_ma_krav_maga = Career(
    ...
    desc="Studying one of the newest and most practical martial arts has taught you to end a fight as soon as it "
...
career_ma_kung_fu = Career(
    ...
    desc="Through intense and dedicated training, you've begun to unlock the secrets of the ancient martial arts of "
...
career_ma_muay_thai = Career(
    ...
    desc="Dedicated conditioning is a part of your daily routine, and you cannot count the number of times you’ve "
...
career_ma_northern_shaolin = Career(
    ...
    desc="Focusing on the use of your legs and staying quick on your feet, you practice styles like Baguazhang, "
...
career_ma_pankration = Career(
    ...
    desc="The truest expression of a person’s fighting ability, some would say, is the ancient art of wrestling—you "
...
career_ma_savate = Career(
    ...
    desc="Training with a champion of the sport or learning the hard way on the meaner streets in Marseille or Paris, "
...
career_ma_southern_shaolin = Career(
    ...
    desc="Your body is a weapon, and your hands are deadly indeed. Using styles like Fujian White Crane, Wing Chun, "
