...
career_ma_aikido = Career(
    ...
    prereq='martial arts',
    agility=1, intuition=1, willpower=1, power=1,
...
career_ma_capoeira = Career(
    ...
    agility=1, intuition=1, luck=1, power=1,
...
career_ma_jujutsu = Career(
    ...
    career_time_unit='years',
    prereq='martial arts',
    strength=1, agility=1, endurance=1, power=1,
...
career_ma_karate = Career(
    ...
    career_time_unit='years',
    prereq='martial arts',
    strength=1, agility=1, willpower=1, power=1,
...
career_ma_muay_thai = Career(
    ...
    career_time_unit='years',
    prereq='martial arts',
    strength=1, endurance=1, willpower=1, power=1,
...
career_ma_savate = Career(
    ...
    career_time_unit='years',
    prereq='martial arts',
    agility=1, endurance=1, luck=1, power=1,
