...
career_new_battlepsyche = Career(
    ...
    endurance=1, willpower=1, power=2,
...
career_new_biopsychic = Career(
    ...
    career_time_unit='years',
    prereq='medicine',
    endurance=1, willpower=1, charisma=1, power=1,
...
career_new_psi_cop = Career(
    ...
    career_time_unit='years',
    prereq='law',
    intuition=1, charisma=1, reputation=1, power=1,
...
career_new_psychic = Career(
    ...
    career_time_unit='years',
    prereq='none',
    intuition=1, luck=1, reputation=1, power=1,
