...
career_woin_origin_acrobat = Career(
    ...
    desc="You've been trained in acrobatics, taught to flip and cartwheel with ease to entertain spectators. Perhaps "
...
career_woin_origin_everyman = Career(
    ...
    desc="Your childhood was characterized only by its unremarkability. A normal childhood and High School "
...
career_woin_origin_experiment = Career(
    ...
    desc="You were the subject of tests and experiments by scientists and doctors, whether created or merely altered. "
...
career_woin_origin_felan_scavenger = Career(
    ...
    desc="With their short lifespans and rapid growth to maturity, the Felan do not form strong family bonds. A "
...
career_woin_origin_geek = Career(
    ...
    desc="You were obsessed with geek culture; you can recite lines from your favorite movies, rules from your "
...
career_woin_origin_jock = Career(
    ...
    desc="You were a football player (or other sportsman) in High School. You developed your physical and social "
...
career_woin_origin_martial_artist = Career(
    ...
    desc="The story of your youth involves disciplined, regimented schooling in a traditional style of fighting, "
...
career_woin_origin_military_brat = Career(
    ...
    desc="You spent time getting shuffled around from military base to military base or otherwise learning from "
         "modern soldiers.",
...
career_woin_origin_page = Career(
    ...
    desc="You spent years in the service of a lord or lady, learning the ways of court, running messages, cleaning, "
         "and serving a noble.",
...
career_woin_origin_service_droid = Career(
    ...
    available_skills=['cooking', 'linguistics', 'engineering', 'computers', 'driving', 'accounting', 'navigation',
                      'astrogation'],
    desc="You were created to perform a specific service – perhaps as a repair droid, domestic bot, astromech, "
         "or a translator.",
...
career_woin_origin_street_tough = Career(
    ...
    desc="You fell in with local gangs and the lower echelons of organized crime, looking up to gangsters as role "
...
career_woin_origin_survivor = Career(
    ...
    desc="The story of your childhood is one of hardship and warzones; you've grown a thick hide from countless "
         "conflicts or wars.",
