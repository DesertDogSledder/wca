...
race_old_danuki = Race(
    name='Danuki',
    desc="Danuki are spirit animals, at home in brush, hills, and ditches. Danuki are a small and very cowardly race. "
...
race_old_deepling = Race(
    name='Deepling',
    desc="Deeplings are a race of cursed beings, corrupted grand elves crossed with demonic ancestry. Hailing from a "
...
race_old_earth_nymph = Race(
    name='Earth Nymph',
    desc="These nymphs arise from stone and soil in their many forms. The most common clan are the oreads, "
...
race_old_grand_elf = Race(
    name='Grand Elf',
    desc="Grand elves are an ancient race. Masters of gunpowder, there is nothing more awe-inspiring than the sight "
...
race_old_flint_dwarf = Race(
    name='Flint Dwarf',
    desc="Crafted from an adaptable, yet flaky stone, Flint Dwarves are physically strong but emotionally volatile. "
...
race_old_jade_dwarf = Race(
    name='Jade Dwarf',
    desc="In many lands, jade is valued as protection against corruption and disease. Jade Dwarves were created from "
...
race_old_ogre = Race(
    name='Ogre',
    desc="Ogres stand 7' tall. Towering masses of muscle, accompanied by green skin and bestial tusks, ogres have a "
...
race_old_orc = Race(
    name='Orc',
    desc="Orcs are tribal, aggressive, violent, quick to anger and easy to offend. Strong and tough, orcs can be a "
...
race_old_water_nymph = Race(
    name='Water Nymph',
    desc="Numerous legends report water nymphs leading foolish men to early ends; indeed, they are the most spirited "
