...
Human adventurers are extremely varied, from private eyes to blackhats, from knights to starship captains, from martial artists to doctors, from wizards to space marines — the world, indeed the universe, is at your fingertips!''',
    ...
    exploits=[{'Name': 'Varied', 'Desc': '''Humans boast more variation within their species than most. Add 2 to any attribute, and add a further +1 to one other attribute (noted above).'''},
              {'Name': 'Explorers', 'Desc': '''Driven by an inquisitive, exploratory nature, Humans recharge their LUC pool every time they go to a country new to them.'''},
...
Examples in popular culture include the Six Million Dollar Man, The Bionic Woman, Darth Vader, Bucky Barnes, Ash, Dr. No, or Robocop.''',
    size='medium',
    endurance=2, strength=2, agility=1,
    available_skills=['hardy', 'perception', 'reactions', '[crafting]', '[trivia]', '[gaming]', '[scientific]',
                      '[technical]'],
    exploits=[{'Name': 'Alteration', 'Desc': '''Augmented begin play with two minor or one major cybernetic alteration.'''},
              {'Name': 'Adaptive', 'Desc': '''When incorporating new cybernetic alterations, uugmented only need to succeed at a Routine [10] END check for the process to take hold successfully. Additionally, they can incorporate an additional two alterations beyond the normal limit of their END attribute.'''},
              {'Name': 'Inert', 'Desc': '''Augmented embrace technology over matters of spirit. They may never have a Chi score above zero.'''}])

race_now_chosen = Race(
    name='Chosen',
    desc='''Something about you is better. Maybe you are the result of a sublime genetic match, perhaps your genome was manipulated from before conception. How it is you came to be different is hardly important—how you are different is everything. Some designed are much more likeable or beautiful than the average human, others possess an evolved mental acuity, and some are sterling models of what biomechanics can achieve.
