...
race_now_chosen = Race(
    name='Chosen',
    desc="Something about you is better. Maybe you are the result of a sublime genetic match, perhaps your genome was "
...
race_now_mutant = Race(
    name='Mutant',
    desc="You are different, your genetics a variation from the norm. This might be blatantly obvious with physical "
